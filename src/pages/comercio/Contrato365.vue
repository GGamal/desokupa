<template>
  <div class="q-pa-md">
    <div>
      <div class="text-h5 text-grey-10 text-weight-medium cursor-pointer" @click="filtrar(null), tab = null">Presupuestos 365</div>
      <div class="text-grey-9">
        {{`En la siguiente tabla puedes revisar los presupuestos de tipo 365\n
    ...
    >
      <template v-slot:body-cell-type="props">
        <q-td :props="props">
          <div class="text-center">Contrato 365</div>
        </q-td>
      </template>
...
export default {
  ...
  methods: {
    getContratos () {
      ...
      this.$api.get('contratos/2').then(res => {
        if (res) {
          this.allData = res
